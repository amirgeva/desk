...
class WindowBox:
    def __init__(self, front_texture, back_texture):
        ...
        self.mn = LPoint3(0,0,0)
        self.mx = LPoint3(0, 0, 0)
    ...
    def update_vertices(self, rect, desktop):
        ...
        d = 5
        # front vertices
        self.mn = LPoint3(-w2,-1,-h)
        self.mx = LPoint3(w2,11,0)
        t2 = 5
        self.vertex.addData3(-w2, -t2, -h)
        self.vertex.addData3(w2, -t2, -h)
        self.vertex.addData3(w2, -t2, 0)
        self.vertex.addData3(-w2, -t2, 0)
        ...
        # frame vertices
        ch = 20
        self.vertex.addData3(-w2, -t2, 0)  # 4
        self.vertex.addData3(-w2, -t2, ch)  # 5
        self.vertex.addData3(-w2, t2, ch)  # 6
        self.vertex.addData3(-w2, t2, -h)  # 7
        self.vertex.addData3(-w2, -t2, -h)  # 8
        self.vertex.addData3(-w2, -t2, -h)  # 9
        self.vertex.addData3(-w2, -t2, ch)  # 10
    ...
    def makeBox(self, front_texture, back_texture):
        ...
        import globals
        cube = NodePath(cube_node)
        # cube = globals.gui.render.attachNewNode(cube_node)
        mat = Material()
